...
# --- Run metaorder and parse output ---
...
def analyze(
    ...
    # Gamma: log-log slope of impact vs executed volume during execution
...
def main():
    ...
    # Compute theoretical terminal impact value
    ...
    # Phase 1: find bracket by doubling m until terminal drops below target
    m_low = 0.0
    m = args.m_start
    m_high = None
